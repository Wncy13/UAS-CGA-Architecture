...
public class PlacementSystem : MonoBehaviour
{
    ...
    private void PlaceStructure()
    {
        ...
        Vector3 mousePosition = inputManager.GetSelectedMapPosition(activeCamera);
    ...
    private void Update()
    {
        ...
        Vector3 newCameraPosition = new Vector3(mouseWorldPosition.x, activeCamera.transform.position.y, mouseWorldPosition.z);

        // Update posisi kamera
        activeCamera.transform.position = newCameraPosition;
